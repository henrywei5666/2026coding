# week03_3.py 學習計畫 Sliding Window 第2題
# LeetCode 1456. Maximum Number of Vowels in a Substring of Given Length
# 母音 Vowels: a,e,i,o,u。長度k的小字串,最多幾個母音
class Solution:
    def maxVowels(self, s: str, k: int) -> int:
        vowels = set('a,e,i,o,u') # 把五個字母,變成set()
        ...
        for i in range(k, N): # 右邊每一個字母,逐一檢查
            if s[i] in vowels: count += 1 # 右邊的頭 s[i] 又吃到1個母音 
            if s[i-k] in vowels: count -= 1 # 左邊的尾巴 s[i-1] 吐掉,失去1個母音
